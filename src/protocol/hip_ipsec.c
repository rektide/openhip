...
extern int pfkey_send_hip_x1 (int,
                              u_int,
                              u_int,
                              u_int,
                              struct sockaddr *,
...
extern int pfkey_send_getspi(int so,
                             u_int satype,
                             u_int mode,
                             struct sockaddr *src,
                             struct sockaddr *dst,
...
extern int pfkey_send_get(int so,
                          u_int satype,
                          u_int mode,
                          struct sockaddr *src,
                          struct sockaddr *dst,
